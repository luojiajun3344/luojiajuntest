	...
	function c(D) {
				...
				function V() {
					...
					function aa(ap, ai, ag) {
						...
						if (a.series.pie.label.background.opacity != 0) {
							...
							b('<div class="pieLabelBackground" style="position:absolute;width:'
									+ an.width()
									+ "px;height:"
									+ an.height()
									+ "px;"
		...
		function J(N) {
			if (a.series.pie.innerRadius > 0) {
				N.save();
				innerRadius = a.series.pie.innerRadius > 1
		...
		function u(R, P) {
			var T = D.getData(), O = D.getOptions(), N = O.series.pie.radius > 1
					? O.series.pie.radius
