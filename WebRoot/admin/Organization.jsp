...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#maingrid").ligerGrid({
        ...
        
           {
        ...
        
			{
				...
				var str1 = '<a  class="l-icon-delete" onclick="operateById(\'删除 \',\'admin/deleteOrganization.action\',' +row.organizationId+ ',\'organization.organizationId\');">&nbsp;&nbsp;&nbsp;&nbsp;</a>';
				return str1;
				}
			...
			dataAction : 'server',
			url : "admin/Organization_getByPage.action?type=1",
			detail : {
		...
		function f_showDetail(row, detailPanel) {
			...
			$.post("admin/searchOrganizationById.action", {
				'user.id' : row.id
			}, function(result)
...
//事件
	function itemclick(item) {
		...
		if (item.id) {
			...
			case "delete":
				...
				var url="admin/deleteOrganizationByList.action";
				var operate="删除";
				post(url,data,operate,'organizationId');return;
	...
	function addOrEditAccount(operate){
		$("#save").click(function() {	
			...
			$.post("admin/Organization_"+operate+".action", {
				'organization.organization_id' : $("#organization_id").val(),
				'organization.organization' : $("#organization").val()
...
function edit(data){
		$.ligerDialog.open({
		  ...
		  $(data).each(function ()
                        ...
                        $("#organization").val(this.organization); 
                            });
			...
			<table width=100% align=center>
				<tbody>
					...
					<tr>
						...
						<td><input type=text name=organization.organization_id id=organization_id>
						</td>
						<td>中文</td>
					</tr>
					...
					<tr>
						<td>organization:</td>
						<td><input type=text name=organization.organization id=organization>
						</td>
						<td>中文</td>
					</tr>
